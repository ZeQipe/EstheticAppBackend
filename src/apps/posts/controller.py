...
def create_post(request):
    ...
    post_data = Post.get_data_in_request(request.POST)
    ...
    post_data["url"] = url = Path(__file__).resolve().parent.parent.parent.parent / 'media' / 'img' / name_file
...
def search_posts(request):
    ...
    try:
        result = Post.get_posts(cookie_user.tags_user, offset, limit)
